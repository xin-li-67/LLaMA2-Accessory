...
def get_args_parser():
    parser = argparse.ArgumentParser('MM-vet evaluation', add_help=False)
    # Model parameters
    ...
    # MM-vet setting
    parser.add_argument("--image_folder", type=str, default="path/to/mm-vet/images")
    parser.add_argument("--question_file", type=str, default="path/to/mm-vet/mm-vet.json")
    parser.add_argument("--answers_file", type=str, default="yourpath/tosave/mmvet-answers.jsonl")
